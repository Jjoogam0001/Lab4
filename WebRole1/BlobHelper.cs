...
namespace WebRole1
{
    ...
    public class BlobHelper
    {
        ...
        public BlobHelper()
        {
            ...
            account = CloudStorageAccount.Parse("DefaultEndpointsProtocol=https;AccountName=martinstorage2019;AccountKey=arqVSiIar1LFWYdToGh47gQ9+LkqnwUBf0T31y5oFQ1FjEv+oW5uqLKh9i9ia1f4kyWZtJO4zO4Aqgjr6/agrw==;EndpointSuffix=core.windows.net");
            ...
            table = cloudTableClient.GetTableReference("comment");
        ...
        public bool UploadBlob(string filePath, string fileName, string userId, string description)
        {
            ...
            string storageConnection = "DefaultEndpointsProtocol=https;AccountName=martinstorage2019;AccountKey=arqVSiIar1LFWYdToGh47gQ9+LkqnwUBf0T31y5oFQ1FjEv+oW5uqLKh9i9ia1f4kyWZtJO4zO4Aqgjr6/agrw==;EndpointSuffix=core.windows.net"; 
            account = CloudStorageAccount.Parse(storageConnection);
            client = account.CreateCloudBlobClient();
            CloudBlobContainer cloudBlobContainer = client.GetContainerReference("blobs");
            ...
            try
            {
                ...
                {
                    // image's meta data
                    cloudBlockBlob.Metadata["owner"] = userId;
                    cloudBlockBlob.Metadata["description"] = description;
                    cloudBlockBlob.Metadata["likes"] = 0 + "";
                    cloudBlockBlob.Metadata["dislikes"] = 0 + "";
                    cloudBlockBlob.Metadata["downloads"] = 0 + "";
