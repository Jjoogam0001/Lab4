...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="auto-style1" style="display: inline-block; border-style: outset;">
            <div class="auto-style3">
                ...
                <br />
                <br />
                <asp:GridView class="auto-style3" DataSourceID="sdcRouteSpec" ID="routesTable" runat="server" AutoGenerateColumns="False" CssClass="auto-style2" Height="16px" Width="908px">
                ...
                <asp:SqlDataSource ID="sdcRouteSpec" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnection %>" SelectCommand="SELECT * FROM [Routes]"></asp:SqlDataSource>
                <br />
