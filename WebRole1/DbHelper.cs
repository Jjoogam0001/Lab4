...
namespace WebRole1
{
    public class DbHelper
    {
        ...
        private readonly string connectionString = "Server=tcp:martin2020i.database.windows.net,1433;Initial Catalog=FlightDB;Persist Security Info=False;User ID=martin2020i;Password=Namagela123i;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
